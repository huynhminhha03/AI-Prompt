    ...
    const fetchData = async () => {
      try {
        const [
          ...
          authAPI().get(adminApis.getCountGiftCodes),
        ...
        setCount({
          ...
          giftcodes: giftcodesResponse.data.count,
      ...
      <div className="row">
        ...
        >
          <div className={cx("card", "bg-warning")}>
            <div className={cx("card-body")}>
              <div>
                <h3 className={cx("quantity")}>{count.giftcodes}</h3>
                <h4 className={cx("title")}>Thẻ quà tặng</h4>
              </div>
              <span className={cx("icon-wrapper")}>
                <i className="fa-solid fa-gift"></i>
              </span>
            </div>
            <Link to={config.routes.giftcode} className={cx("more-info")}>
              <span>Xem thêm </span>
              <NextArrowIcon />
            </Link>
          </div>
